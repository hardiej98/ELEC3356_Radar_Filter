...
HD_PWD='C:/Users/hardi/Documents/ELEC3356-01 Digital Systems/Projects/Radar Filter Final Project/Radar_Filter/Radar_Filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Radar_Filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Radar_Filter.tcl
