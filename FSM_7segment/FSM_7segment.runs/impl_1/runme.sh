...
HD_PWD='C:/Users/hardi/Documents/ELEC3356-01 Digital Systems/Projects/Radar Filter Final Project/FSM_7segment/FSM_7segment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_7segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_7segment.tcl -notrace
