...
HD_PWD='C:/Users/hardi/Documents/ELEC3356-01 Digital Systems/Projects/Radar Filter Final Project/FSM_7segment/FSM_7segment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_7segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_7segment.tcl
