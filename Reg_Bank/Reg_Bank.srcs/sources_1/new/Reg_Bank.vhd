...
architecture Behavioral of Reg_Bank is
    ...
    type reg_array_type is array (0 to 8) of std_logic_vector(5 downto 0);
    signal regs : reg_array_type := (others => (others => '0'));

begin

    -- Single synchronous process: NO combinational feedback.
    process(clk)
    begin
    ...
    -- Continuous drive of outputs from regs
    r0 <= regs(0);
    r1 <= regs(1);
    r2 <= regs(2);
    r3 <= regs(3);
