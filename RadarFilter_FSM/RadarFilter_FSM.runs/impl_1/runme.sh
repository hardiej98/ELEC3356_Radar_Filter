...
HD_PWD='C:/Users/hardi/Documents/ELEC3356-01 Digital Systems/Projects/Radar Filter Final Project/RadarFilter_FSM/RadarFilter_FSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RadarFilter_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RadarFilter_FSM.tcl -notrace
