...
HD_PWD='C:/Users/hardi/Documents/ELEC3356-01 Digital Systems/Projects/Radar Filter Final Project/RadarFilter_FSM/RadarFilter_FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RadarFilter_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RadarFilter_FSM.tcl
